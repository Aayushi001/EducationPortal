            ...
            <div class="container-fluid">
                ...
                <ul class="nav nav-pills nav-stacked custom-nav">
                    ...
                    <li><a href="#"><i class="fa fa-check-square-o"></i><span> Enrolled Courses</span></a></li>
                     <li><a href="<?php echo e(url('/admin/add')); ?>"><i class="fa fa-plus"></i><span> Add</span></a></li>
                    <li><a href="<?php echo e(url('/admin/assign-roles')); ?>"><i class="fa fa-user"></i><span> Assign Roles</span></a></li>
                         ...
                         <div class="col-md-3">
                            <div class="panel">
                                ...
                                <div class="panel-body" style="background-color: #3991db;color: #fff;height: 130px; padding:30px; font-size:38px;">
                                    <i class="fa fa-users fa-2x" style="float:left;"></i><span style="font-size:52px;">&nbsp;<?php echo e($usersCount); ?></span>
                                </div>
                            </div>   
                        </div>
