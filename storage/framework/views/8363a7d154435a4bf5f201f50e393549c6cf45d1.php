...
<head>
	...
	<link href="<?php echo e(URL::asset('css/style.css')); ?>" rel="stylesheet" type="text/css" >
		...
		<script src="<?php echo e(URL::asset('public/js/scrollreveal.js')); ?>"></script>
 ...
 <a class="navbar-brand  page-scroll" href="<?php echo e(url('/')); ?>">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="page-scroll" href="<?php echo e(url('/')); ?>">Home</a></li>
                        <li><a class="page-scroll" href="#why">Why Us</a></li>
                    ...
                    <?php if(Auth::guest()): ?>
                         ...
                         <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" id="borderless">
                                 <i class="fa fa-lock"><span style="font-size: 20px; font-weight: bolder;"> Log in</span></i>
                            </a>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                 <li><a href="<?php echo e(url('/profile')); ?>" id="borderless-menu"><i class="fa fa-btn fa-user"></i>My Profile</a></li>
                                  <li><a href="#" id="borderless-menu"><i class="fa fa-btn fa-cog"></i>Settings</a></li>
