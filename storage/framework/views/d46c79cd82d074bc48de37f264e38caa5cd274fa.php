...
<head>
	...
	<link href="<?php echo e(URL::asset('css/style.css')); ?>" rel="stylesheet" type="text/css" >
		...
		<script src="<?php echo e(URL::asset('js/scrollreveal.js')); ?>"></script>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="<?php echo e(route('questions')); ?>">Questions</a></li>
                       
                        <li><a href="#">FAQ</a></li>
                        <li><a href="<?php echo e(route('ask-question')); ?>">Ask Question</a></li>
